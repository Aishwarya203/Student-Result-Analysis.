...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        for ($i = 0; $i < count($mark); $i++) {
            $mar = $mark[$i];
            $internal = $internal_list[$i];
            $exte = $external_list[$i];
            $sid = $sid1[$i];
            $sql = "INSERT INTO  tblresult(StudentId,ClassId,SubjectId,internal,exte,marks) VALUES(:studentid,:class,:sid,:internal,:exte,:marks)";
            $query = $dbh->prepare($sql);
            $query->bindParam(':studentid', $studentid, PDO::PARAM_STR);
            $query->bindParam(':class', $class, PDO::PARAM_STR);
            $query->bindParam(':sid', $sid, PDO::PARAM_STR);
            $query->bindParam(':internal', $internal, PDO::PARAM_STR);
            $query->bindParam(':exte', $exte, PDO::PARAM_STR);
...
?>
    ...
    <head>
        ...
        <title>AMCEC Admin| Add Result </title>
