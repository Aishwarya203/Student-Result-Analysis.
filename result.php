...
<p><b>Student USN :</b> <?php echo htmlentities($row->RollId);?>
...
// Code for result
 ...
 $query ="select t.StudentName,t.RollId,t.ClassId,t.internal,t.exte,t.marks,SubjectId,tblsubjects.SubjectName from (select sts.StudentName,sts.RollId,sts.ClassId,tr.internal,tr.exte,tr.marks,SubjectId from tblstudents as sts join  tblresult as tr on tr.StudentId=sts.StudentId) as t join tblsubjects on tblsubjects.id=t.SubjectId where (t.RollId=:rollid and t.ClassId=:classid)";
...
foreach($results as $result){
    ?>
                                                ...
                                                <th scope="row"><?php echo htmlentities($cnt);?></th>
                                                			...
                                                			<td><?php echo htmlentities($result->internal);?></td>
                                                			<td><?php echo htmlentities($result->exte);?></td>
                                                		</tr>
<?php 
...
?>
        ...
        <script>
            ...
            function download() {
                alert("No this won't work for now.");
            }
        </script>
