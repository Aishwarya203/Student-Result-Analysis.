...
if(!empty($_POST["classid1"])) 
{
 ...
 while($row=$stmt->fetch(PDO::FETCH_ASSOC))
 {?>
  <p><?php echo htmlentities($row['SubjectName']); ?><input type="text"  name="internal[]" value="" class="form-control" required="" placeholder="Enter internal marks out of 50" autocomplete="off"><input type="text"  name="external[]" value="" class="form-control" required="" placeholder="Enter external marks out of 50" autocomplete="off"><input type="text"  name="marks[]" value="" class="form-control" required="" placeholder="Enter total marks out of 100" autocomplete="off"></p>
