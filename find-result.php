                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="rollid">Enter your USN</label>
                                        <input type="text" class="form-control" id="rollid" placeholder="Enter Your USN" autocomplete="off" name="rollid">
                                	</div>
                               <div class="form-group">
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>Copyright © 2023 AMCEC</small></p>
                    </div>
